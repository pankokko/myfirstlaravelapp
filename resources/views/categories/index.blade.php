  ...
  <div class="categories-wrapper-container">
    <div class="categories-wrapper-container-picture"> 
      <a class="categories-wrapper-container-picture-link" href="/categories/{{$landscape->first()->category_id}}/list">
        <img class="categories-wrapper-container-picture-link-img" src="{{asset('storage/thumbnail/1578464927.DSC02568.JPG')}}"width="260" height="300">
      </a>
    ...
    <div class="categories-wrapper-container-picture"> 
      <a class="categories-wrapper-container-picture-link" href="/categories/{{$city->first()->category_id}}/list">
        <img class="categories-wrapper-container-picture-link-img" src="{{asset("storage/thumbnail/1578465264.DSC00290.JPG")}}"width="260" height="300">
      </a>
    ...
    <div class="categories-wrapper-container-picture"> 
      <a class="categories-wrapper-container-picture-link" href="/categories/{{$person->first()->category_id}}/list">
        <img class="categories-wrapper-container-picture-link-img" src="{{asset('storage/thumbnail/1578465407.DSC00294.JPG')}}"width="260" height="300">
      </a>
    ...
    <div class="categories-wrapper-container-picture"> 
      <a class="categories-wrapper-container-picture-link" href="/categories/{{$creature->first()->category_id}}/list">
        <img class="categories-wrapper-container-picture-link-img" src="{{asset('storage/thumbnail/1578465315.DSC00371.JPG')}}"width="260" height="300">
      </a>
